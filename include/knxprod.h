...
// Offset: 3, BitOffset: 2, Size: 1 Bit, Text: RemoteDebug aktivieren
#define ParamAPP_RemoteDebug knx.paramBit(APP_RemoteDebug, 2)
#define APP_Temperatur_DPT		0x0003
// Offset: 3, BitOffset: 3, Size: 1 Bit, Text: Sende Temperatur als
#define ParamAPP_Temperatur_DPT knx.paramBit(APP_Temperatur_DPT, 3)
...
// Offset: 3, BitOffset: 4, Size: 1 Bit, Text: Sende Feuchte als
#define ParamAPP_Feuchte_DPT knx.paramBit(APP_Feuchte_DPT, 4)
...
// Offset: 3, BitOffset: 5, Size: 1 Bit, Text: Sende Windgeschwindigkeit als
#define ParamAPP_WindSpeed_DPT knx.paramBit(APP_WindSpeed_DPT, 5)
#define APP_WindDir_DPT		0x0003
// Offset: 3, BitOffset: 6, Size: 1 Bit, Text: Sende Windgeschwindigkeit als
#define ParamAPP_WindDir_DPT knx.paramBit(APP_WindDir_DPT, 6)
#define APP_WindSpeed_Senden_zyklisch		0x0092
#define APP_WindSpeed_Senden_zyklisch_Shift	4
#define APP_WindSpeed_Senden_zyklisch_Mask	0x0FFF
// Offset: 146, Size: 12 Bit, Text: Sende Windgeschwindigket alle
...
#define APP_WindSpeed_Senden_Wertaenderung_absolut		0x0094
// Offset: 148, Size: 16 Bit (2 Byte), Text: Sende bei Änderung um
...
#define APP_WindSpeed_Senden_Wertaenderung_relativ		0x0096
...
#define APP_WindDir_Senden_zyklisch		0x0098
#define APP_WindDir_Senden_zyklisch_Shift	4
#define APP_WindDir_Senden_zyklisch_Mask	0x0FFF
// Offset: 152, Size: 12 Bit, Text: Sende Windrichtung alle
...
#define APP_WindDir_Senden_Wertaenderung_absolut		0x009A
// Offset: 154, Size: 16 Bit (2 Byte), Text: Sende bei Änderung um
...
#define APP_WindDir_Senden_Wertaenderung_relativ		0x009C
...
#define APP_Pressure_DPT		0x0003
// Offset: 3, BitOffset: 7, Size: 1 Bit, Text: Sende Luftdruck als
#define ParamAPP_Pressure_DPT knx.paramBit(APP_Pressure_DPT, 7)
#define APP_Pressure_Senden_zyklisch		0x009E
#define APP_Pressure_Senden_zyklisch_Shift	4
#define APP_Pressure_Senden_zyklisch_Mask	0x0FFF
// Offset: 158, Size: 12 Bit, Text: Sende Luftdruck alle
...
#define APP_Pressure_Senden_Wertaenderung_absolut		0x00A0
// Offset: 160, Size: 16 Bit (2 Byte), Text: Sende bei Änderung um
...
#define APP_Pressure_Senden_Wertaenderung_relativ		0x00A2
// Offset: 162, Size: 16 Bit (2 Byte), Text: Sende bei Änderung um
...
//!< Number: 9, Text: Windgeschwindigkeit (m/s), Function: Messwert
#define APP_KoWindSpeed_DPT9 9
#define KoAPP_WindSpeed_DPT9 knx.getGroupObject(APP_KoWindSpeed_DPT9)
//!< Number: 9, Text: Windgeschwindigkeit (m/s), Function: Messwert
#define APP_KoWindSpeed_DPT14 9
#define KoAPP_WindSpeed_DPT14 knx.getGroupObject(APP_KoWindSpeed_DPT14)
//!< Number: 10, Text: Windgeschwindigkeit in Böen (m/s), Function: Messwert
#define APP_KoGustSpeed_DPT9 10
#define KoAPP_GustSpeed_DPT9 knx.getGroupObject(APP_KoGustSpeed_DPT9)
//!< Number: 10, Text: Windgeschwindigkeit in Böen (m/s), Function: Messwert
#define APP_KoGustSpeed_DPT14 10
#define KoAPP_GustSpeed_DPT14 knx.getGroupObject(APP_KoGustSpeed_DPT14)
//!< Number: 11, Text: Windrichtung (Grad), Function: Messwert
#define APP_KoWindDir_DPT9 11
#define KoAPP_WindDir_DPT9 knx.getGroupObject(APP_KoWindDir_DPT9)
//!< Number: 11, Text: Windrichtung (Grad), Function: Messwert
#define APP_KoWindDir_DPT14 11
